Binexus-qt: Qt4 GUI for Binexus
===============================
...
Alternatively, install Qt Creator and open the `Binexus-qt.pro` file.

An executable named `Binexus-qt` will be built.
...
A warning for people using the *static binary* version of Binexus on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Binexus is linked against libdb5.3.
...
installed causes Binexus-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
