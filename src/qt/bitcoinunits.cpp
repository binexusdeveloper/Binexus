...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BNXS");
    case mBTC: return QString("mBNXS");
    case uBTC: return QString::fromUtf8("μBNXS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Binexuss"));
    case mBTC: return QString(QObject::tr("Milli-Binexuss (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Binexuss (1 / 1,000,000)"));
    default: return QString("???");
    }
}
