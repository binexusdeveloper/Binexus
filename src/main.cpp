...
const string strMessageMagic = "Binexus Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 2 * CENT;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Binexus
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // Binexus: check proof-of-stake block signature
...
bool CBlock::AcceptBlock()
{
    ...
    int64_t nMaxOffset = 88 * 86400; // Eight days
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Binexus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "binexus genesis";
        CTransaction txNew;
        txNew.nTime = 1518025076;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1518025076;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 567744; // !fTestNet ? 1575379 : 46534;
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        //// debug print
        // (block.hashMerkleRoot == uint256("0x4cb33b3b6a861dcbc685d3e614a9cafb945738d6833f182855679f2fad02057b"));
...
unsigned char pchMessageStart[4] = { 0xc4, 0xf2, 0xe2, 0xe5 };
